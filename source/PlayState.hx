...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (SONG.song == 'Tutorial')
			healthBar.createFilledBar(FlxColor.fromRGB(165, 0, 77), FlxColor.fromRGB(49, 176, 209));

		if (SONG.song == 'Bopeebo' || SONG.song == 'Fresh' || SONG.song == 'Dad Battle')
			healthBar.createFilledBar(FlxColor.fromRGB(175, 102, 206), FlxColor.fromRGB(49, 176, 209));

		if (SONG.song == 'Spookeez' || SONG.song == 'South')
			healthBar.createFilledBar(FlxColor.fromRGB(213, 126, 0), FlxColor.fromRGB(49, 176, 209));

		if (SONG.song == 'Monster')
			healthBar.createFilledBar(FlxColor.fromRGB(243, 255, 110), FlxColor.fromRGB(49, 176, 209));

		if (SONG.song == 'Pico' || SONG.song == 'Philly Nice' || SONG.song == 'Blammed')
			healthBar.createFilledBar(FlxColor.fromRGB(183, 216, 85), FlxColor.fromRGB(49, 176, 209));

		if (SONG.song == 'Satin Panties' || SONG.song == 'High' || SONG.song == 'Milf')
			healthBar.createFilledBar(FlxColor.fromRGB(216, 85, 142), FlxColor.fromRGB(49, 176, 209));
		...
		if (SONG.song == 'Senpai' || SONG.song == 'Roses')
			healthBar.createFilledBar(FlxColor.fromRGB(255, 170, 111), FlxColor.fromRGB(123, 214, 246));

		if (SONG.song == 'Thorns')
			healthBar.createFilledBar(FlxColor.fromRGB(255, 60, 110), FlxColor.fromRGB(123, 214, 246));
		...
		var healthEngineVersion:FlxText = new FlxText(5, FlxG.height - 45, 0, "" + ('Health Engine | v1.2.4'), 12);
		healthEngineVersion.scrollFactor.set();
		healthEngineVersion.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		healthEngineVersion.borderColor = FlxColor.BLACK;
		healthEngineVersion.borderSize = 1;
		healthEngineVersion.borderStyle = FlxTextBorderStyle.OUTLINE;
		add(healthEngineVersion);
		...
		doof.cameras = [camHUD];
		healthEngineVersion.cameras = [camHUD];
